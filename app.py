...
age = st.number_input("반을 입력 해주세요", min_value=1, max_value=100, value=1) # 기본값(value)을 반에 맞게 1로 수정했습니다.
...
if st.button("확인"):
    st.success(f"이름: {user_id}님 | 학년: {ai_model} | 반: {age}반 | 난이도: {ai_speed}")
